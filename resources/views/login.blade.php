...
<body>
    <div class="particles-container">
        @for ($i = 0; $i < 40; $i++)
            <div class="particle" style="left: {{ rand(0, 100) }}%; top: {{ rand(-20, 120) }}vh; animation-delay: {{ rand(0, 20) / 10 }}s; animation-duration: {{ rand(16, 30) }}s;"></div>
        @endfor
    </div>
                ...
                <section class="form-panel">
                    ...
                    <form method="POST" action="/login" class="space-y-5">
                        ...
                        <div class="form-field">
                            ...
                            <input id="email" name="email" type="email" value="{{ old('email') }}" placeholder="nama@email.com" class="form-input" required>
                        </div>
