...
<div class="dashboard-wrapper">
        ...
        <main class="main-content">
            <section class="dashboard-hero-panel">
                <div class="hero-copy">
                    <p class="hero-eyebrow">Selamat datang kembali, {{ Auth::user()->name }}.</p>
                    <h1 class="hero-title">Dashboard Pembelajaran Modern Anda.</h1>
                </div>
                <div class="hero-actions">
                    <div class="hero-chip">
                        <span>Mode Saat Ini</span>
                        <strong>{{ session('selected_mood', 'Biasa') }}</strong>
                    </div>
                    <div class="hero-chip soft">
                        <span>Progress</span>
                        <strong>{{ $completedMateri ?? '0' }} / {{ $totalMateri ?? '0' }} Materi</strong>
                    </div>
                    <a href="{{ route('mood.selection') }}" class="hero-chip mood-link" aria-label="Kembali ke Pemilihan Mood">
            ...
            <section class="content-grid">
                ...
                <a href="{{ route('materi.index') }}" class="card-link">
                ...
                <a href="{{ route('video.index') }}" class="card-link">
                ...
                <!-- Evaluasi (Bawah-Kiri) -->
                <a href="{{ route('kuis.index') }}" class="card-link">
                ...
                <a href="{{ route('progress.index') }}" class="card-link">
            ...
            <a href="{{ route('ki-kd') }}" class="competency-panel-link">
