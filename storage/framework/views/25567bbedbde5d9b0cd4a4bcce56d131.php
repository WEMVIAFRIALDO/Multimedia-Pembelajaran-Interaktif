...
<?php $__env->startSection('title', 'Bantuan - Mood-Sync'); ?>
    ...
    <div class="container max-w-4xl mx-auto px-4">
        <div class="rounded-[2rem] border border-slate-800 bg-slate-900/95 p-8 shadow-2xl">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between mb-10">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 rounded-2xl bg-amber-400 px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-amber-300">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\kuliah\WEMVI\Semester 4\Multimedia Pembelajaran Interaktif\Project\mood-sync\resources\views/bantuan.blade.php ENDPATH**/ ?>