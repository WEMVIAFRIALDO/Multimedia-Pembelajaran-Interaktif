...
<div class="min-h-screen py-8 md:py-12 bg-slate-950">
    <div class="container max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                ...
                <div class="mt-4 md:mt-0 px-4 py-2 bg-slate-800/70 border border-slate-600/60 rounded-xl shadow-sm">
                    <p class="text-blue-200 text-sm font-semibold">
                        😊 Mood Anda: <span class="text-white font-bold"><?php echo e($selectedMood); ?></span>
                    </p>
                </div>
            </div>
        ...
        <?php if($kelas->count() > 0): ?>
            <?php $sortedKelas = $kelas->sortBy('kelas'); ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                <?php $__currentLoopData = $sortedKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('materi.jurusan', $k->kelas)); ?>" class="group cursor-pointer block">
                        <div class="relative h-full bg-slate-900/80 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:border-green-400/50 transition-all duration-200 group-hover:shadow-lg group-hover:shadow-green-400/10 overflow-hidden">
                            ...
                            <div class="relative z-10 flex flex-col items-center text-center">
                                ...
                                <h3 class="text-xl md:text-2xl font-bold text-slate-100 mb-2 group-hover:text-green-400 transition-colors duration-200">
                                    Kelas <?php echo e($k->kelas); ?>

                                </h3>

                                <!-- Description -->
                                <p class="text-slate-300 mb-4">
                                    Materi pembelajaran untuk Kelas <?php echo e($k->kelas); ?>
        ...
        <?php else: ?>
            ...
            <div class="flex flex-col items-center justify-center py-12 text-center">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="px-6 py-3 bg-amber-400 text-slate-900 font-bold rounded-xl hover:shadow-lg transition-all">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\kuliah\WEMVI\Semester 4\Multimedia Pembelajaran Interaktif\Project\mood-sync\resources\views/materi/index.blade.php ENDPATH**/ ?>