...
<?php $__env->startSection('title', 'Video Pembelajaran'); ?>
        ...
        <?php if($kelas->count() > 0): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('video.jurusan', $item->kelas)); ?>" class="group cursor-pointer block">
                        <div class="relative h-full bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-[2rem] p-10 hover:border-amber-400/50 transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-amber-400/20 overflow-hidden">
                            ...
                            <div class="relative z-10">
                                ...
                                <h3 class="text-2xl font-bold text-slate-100 mb-2 group-hover:text-amber-500 transition-colors duration-200">
                                    Kelas <?php echo e($item->kelas); ?>

                                </h3>

                                <!-- Kelas Description -->
                                <p class="text-slate-300 mb-6">
                                    Pembelajaran video untuk kelas <?php echo e($item->kelas); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\kuliah\WEMVI\Semester 4\Multimedia Pembelajaran Interaktif\Project\mood-sync\resources\views/video/index.blade.php ENDPATH**/ ?>