...
<div class="mood-picker-page min-h-screen flex items-center justify-center py-12">
    <div class="mood-picker-shell mx-auto w-full max-w-7xl px-4">
        ...
        <form action="<?php echo e(route('mood.set')); ?>" method="POST" class="grid gap-6 md:grid-cols-3">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\kuliah\WEMVI\Semester 4\Multimedia Pembelajaran Interaktif\Project\mood-sync\resources\views/mood/pilih.blade.php ENDPATH**/ ?>