    ...
    <div class="container max-w-7xl mx-auto px-4 md:px-8">
        ...
        <?php if($kuis->count() > 0): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                <?php $__currentLoopData = $kuis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="group cursor-pointer">
                        <a href="<?php echo e(route('kuis.show', $k->id)); ?>" class="block h-full">
                            <div class="relative h-full bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-[2rem] p-10 hover:border-amber-400/50 transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-amber-400/20 overflow-hidden">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <p class="text-sm text-slate-300 mb-4">
                                        ...
                                        <?php echo e($k->material->title ?? 'Materi Tidak Ditemukan'); ?>
                                    ...
                                    <div class="grid grid-cols-2 gap-3 mb-6">
                                        ...
                                        <div class="bg-blue-500/10 rounded-lg p-3 border border-blue-500/30">
                                            ...
                                            <p class="text-2xl font-bold text-blue-200"><?php echo e(count($k->pertanyaan ?? [])); ?></p>
                                        </div>
                                        ...
                                        <div class="bg-orange-500/10 rounded-lg p-3 border border-orange-500/30">
                                            ...
                                            <p class="text-lg font-bold text-orange-200"><?php echo e($k->kesulitan ?? 'Sedang'); ?></p>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\kuliah\WEMVI\Semester 4\Multimedia Pembelajaran Interaktif\Project\mood-sync\resources\views/kuis/index.blade.php ENDPATH**/ ?>