...
<div class="particles-container">
    <?php for($i = 0; $i < 15; $i++): ?>
        <div class="particle" style="left: <?php echo e(rand(0, 100)); ?>%; animation-delay: <?php echo e(rand(0, 8)); ?>s; animation-duration: <?php echo e(rand(8, 15)); ?>s;"></div>
    <?php endfor; ?>
</div>
    ...
    <div class="container max-w-6xl mx-auto px-4">
        <div class="rounded-xl border border-white/10 bg-slate-900/80 p-4 shadow-md backdrop-blur-sm text-slate-100 mb-8">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-4">
                <div>
                    <h1 class="h2 mb-2 text-white">📖 <?php echo e($material->title); ?></h1>
                    <p class="text-slate-300 mb-2">
                        Kelas <?php echo e($material->kelas); ?> | <?php echo e($material->jurusan); ?> | <?php echo e($material->mata_pelajaran); ?>

                    </p>
                    <?php if($selectedMood === 'Fokus'): ?>
                        <span class="badge bg-primary mt-2">Tingkat Detail: Tinggi</span>
                    <?php elseif($selectedMood === 'Lelah'): ?>
        ...
        <div class="rounded-xl border border-white/10 bg-slate-900/80 p-4 shadow-md backdrop-blur-sm text-slate-100 mb-8">
            ...
            <?php if(session('user_mood') == 'fokus'): ?>
            ...
            <?php elseif(session('user_mood') == 'lelah'): ?>
        ...
        <div class="rounded-xl border border-white/10 bg-slate-900/80 p-4 shadow-md backdrop-blur-sm text-slate-100">
            <div class="d-flex flex-column flex-md-row gap-3">
                <form action="<?php echo e(route('materi.completed', $material->id)); ?>" method="POST" style="flex: 1;">
                    <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    const currentMood = '<?php echo e(session('user_mood')); ?>' || 'fokus';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\kuliah\WEMVI\Semester 4\Multimedia Pembelajaran Interaktif\Project\mood-sync\resources\views/materi/show.blade.php ENDPATH**/ ?>